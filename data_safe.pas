...
var
  ...
  e: TEventItem;
begin
  if Data.fFileVersion>= 21 then      // ���� ���� GID, �� ������, ����� ������� �����
...
//    bytotal: boolean;
  ...
  _gender := '';
  _sn := Event.ShortName;
        if (Length(_sn) > 0) and ((_sn[Length(_sn)] = '�') or (_sn[Length(_sn)] = '�')) then
        begin
          if _sn[Length(_sn)] = '�' then
            _gender := '�������'
          else if _sn[Length(_sn)] = '�' then
            _gender := '�������';
        end
        else if Pos('���', LowerCase(Event.Name)) > 0 then
          _gender := '�������'
        else if Pos('���', LowerCase(Event.Name)) > 0 then
          _gender := '�������';
