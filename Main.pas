...
uses
  ...
  Vcl.Imaging.pngimage,  // �������� PNGimage �� ���������� ��������� PNG
  MyPrint,
...
var
  ...
  EmbedFontFilesToPDF: Boolean;  // ��������� ���������� ��� PDF ����������������
...
const
  MARKED_STR: string= '��������: %d';
  RUSSIAN_CHARSET = 204;  // ��������� ��������� ��� PDF ����������������
  PROTOCOL_CHARSET = 204; // ��������� ��������� ��� ����������
...
begin
  // ������ �������� PDF ����� ���������� ������ �� PDF �������
  ShowMessage('�������� PDF ������� (��������, Microsoft Print to PDF) ��� ���������� � PDF');
...
begin
  ...
  try
    ...
    on E: Exception do
      MessageDlg(Format('%s%s����: %s%s�������: %s', [Language['SaveDataError'], sLineBreak, fname, sLineBreak, E.Message]), mtError, [mbOk], 0)
    else
