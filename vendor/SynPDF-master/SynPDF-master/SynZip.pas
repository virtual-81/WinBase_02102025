...
{$IFDEF USEDELPHIZLIB} {$MESSAGE HINT 'SynZip: using System.ZLib'} {$ENDIF}
{$IFDEF USEINLINEASM} {$MESSAGE HINT 'SynZip: inline asm ON'} {$ENDIF}
{$IFDEF USEEXTZLIB} {$MESSAGE HINT 'SynZip: external libz ON'} {$ENDIF}

{$I Synopse.inc} // define HASINLINE CPU32 CPU64
// Hard force Delphi/Windows to use System.ZLib (no external OBJ, no inline asm)
...
// Ensure Delphi uses System.ZLib path on Windows when requested by project define.
// The block above re-enables USEINLINEASM for Win32 by default; override it here.
{$ifdef MSWINDOWS}
  {$ifdef USEDELPHIZLIB}
    {$undef USEINLINEASM}
    {$IFDEF VER320} {$MESSAGE HINT 'SynZip: forcing System.ZLib (no inline asm)'} {$ENDIF}
  {$endif}
{$endif}
