...

{
  ...
  Version 1.535
  2006-04-21 - IMPROVE 1 - Now the library uses System.SysUtils, the latest ZLIB release (1.2.3)
  ...
  Version 1.421
  2002-05-06 - Now uses System.SysUtils, new ZLIB version, 1.1.4 with some security
               fixes.
...
uses
 System.SysUtils, Windows {$IFDEF UseDelphi}, System.Classes, Vcl.Graphics, SysUtils{$ENDIF},
 zlibpas, pnglang;
...
type
  ...
  public
    ...
    {Returns if it uses System.SysUtils, bit transparency}
...
begin
  ...
  {Sets that it uses System.SysUtils, bit transparency}
...
begin
  ...
  case Header.ColorType of
    ...
    begin
      ...
      {Tests if it uses System.SysUtils, bit transparency}
...
var
  ...
  palEntries: TMaxLogPalette;
begin
  {In case the image uses System.SysUtils, grayscale, build a grayscale palette}
  with Header do
...
var
  ...
  IDATCRC    : Cardinal;
begin
  {Uses System.SysUtils, internal record pointed by ZLIBStream to gather information}
...
begin
  ...
  with Header do
    case ColorType of
      {Palette uses System.SysUtils, the TChunktRNS to store alpha}
      COLOR_PALETTE:
      begin
       TRNS := Chunks.ItemFromClass(TChunkTRNS) as TChunkTRNS;
...
{Returns pixel when png uses System.SysUtils, RGB}
...
{Sets pixel when png uses System.SysUtils, RGB}
...
{Returns pixel when png uses System.SysUtils, grayscale}
...
{Sets pixel when png uses System.SysUtils, grayscale}
