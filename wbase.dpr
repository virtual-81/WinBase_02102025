...
//  report_startlist in 'report_startlist.pas';

{$R *.res}

begin
  // Инициализация кодировки для корректного отображения корейских символов
  {$IFDEF MSWINDOWS}
  // Установка консольной кодировки для отладки
  SetConsoleOutputCP(CP_UTF8);
  SetConsoleCP(CP_UTF8);
  
  // Установка кодировки по умолчанию для строк
